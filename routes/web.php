...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/students/edit/{id}',[App\Http\Controllers\Student\StudentController::class,'edit'])->name('edit');
    ...
    Route::put('/students/update/{id}',[App\Http\Controllers\Student\StudentController::class,'update'])->name('update');
